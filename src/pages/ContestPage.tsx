      ...
      <Box minH="80vh" bg="gray.900">
        ...
        <Center>
          ...
          >
            <Table size="lg">
              <TableCaption>
                {store.activeContests.length > 0
                  ? 'All active contests'
                  : 'There is no contest running at this time!'}
              </TableCaption>
              <Thead>
                <Tr>
              ...
              <Tbody>
                {store.activeContests.map((contest, index) => (
                  <Tr key={contest.id}>
                    ...
                    <Td textAlign="center">
                      {store.getContestDescription(contest)}
                    </Td>
                    <Td textAlign="center">
          ...
          <>
            <Center py={12}>
              <Heading color="gray.50">
                Temporary Leaderboard for contest No. {index + 1}
              </Heading>
            </Center>
            <Center>
              <TableContainer
              ...
              >
                <Table size="lg">
                  <TableCaption>
                    {contest.contestUsers.length > 0
                      ? 'All users registered in the context last time we checked'
